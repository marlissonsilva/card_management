    ...
    <section className={styles.section}>
      <div className={styles.tabs_container}>
        <button
          ...
          onClick={() => { setAction("account"); reset(); }}
        >
      ...
      <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        {!isLogin && (
          <div className={styles.input_group}>
            <label>Digite seu nome <input type="text" {...register("username")} /></label>
        ...
        <div className={styles.input_group}>
          <label>Digite seu email <input type="email" {...register('email')} /></label>
        ...
        <div className={styles.input_group}>
          <label>Digite sua senha <input type="password" {...register("password")} /></label>
          ...
          <div className={styles.input_group}>
            <label>
              ...
              <input
                ...
                min="1"
                max="31"
                onChange={(event) => setValue("invoice_closing", Number(event.target.value))}
              />
            </label>
            {errors.invoice_closing?.message && (
              <span className={styles.error_message}>{errors.invoice_closing.message}</span>
            )}
          </div>
        )}
